...
class Tests {
    ...
    @Tag("Hard")
    fun mostExpensive() {
        assertEquals("Any good with price 0.0", mostExpensive("BtW%&JW8CWfZ/15D 0"))
    ...
    @Tag("Hard")
    fun fromRoman() {
        assertEquals(-1, fromRoman("\"e5+1(khH!MI1,&'YX.oThNAn30g)9`M@PNrkmH=T#}$ uRhXe;~/JdIwC:]#uvb>7I^B,%;$%T[q\\LR!@&X\n>,.&n0DK#"))
